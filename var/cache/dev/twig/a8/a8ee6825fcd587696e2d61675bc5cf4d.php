...
class __TwigTemplate_9c971d1759f4179051c5e92007ba2a7e extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <!-- Intégrez ici le contenu de votre template de produit -->

    <!-- Par exemple, vous pouvez copier la structure de la section des derniers produits -->
    <section class=\"popular-items\">
        <div class=\"container\">
            <!-- Copiez ici le contenu de la section des derniers produits de votre template de produit -->
        </div>
    </section>

    <!-- Ajoutez ensuite les sections spécifiques à votre panier -->
    <div class=\"section\">
        <div class=\"container\">
            <!-- Contenu spécifique au panier -->
            <div class=\"row\">
...
{% block body %}
    <!-- Intégrez ici le contenu de votre template de produit -->
...
{% endblock %}
", "panier/index.html.twig", "C:\\Users\\MSII\\Desktop\\projet_pidev\\projet_wetek\\templates\\panier\\index.html.twig");
    }
}
