 ...
 */
final class Version20240222221537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, numliv VARCHAR(255) NOT NULL, zoneliv VARCHAR(255) NOT NULL, dateliv DATETIME NOT NULL, etatliv VARCHAR(255) NOT NULL, idlivreur_id INT DEFAULT NULL, INDEX IDX_A60C9F1F35CD7A3B (idlivreur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
