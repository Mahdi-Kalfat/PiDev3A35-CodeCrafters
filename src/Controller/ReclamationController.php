...
class ReclamationController extends AbstractController
{
    ...
    public function creecompte(EntityManagerInterface $em,Request $req,ReclamationRepository $RR)
    {
       ...
       if ($form->isSubmitted() && $form->isValid()){
        ...
        if ($imageFile) {
            ...
            $imageFile->move(
                'C:\Users\mehdi\OneDrive\Desktop\projet_mahdi\integration\public\imgrec', // Répertoire de stockage des images
                $newFileName
            );
    ...
    public function showf(ReclamationRepository $RR,Request $request,SessionInterface $session): Response
    {
        $tri = $request->query->get('tri');
        $reclamations = new Reclamation();
    ...
    {
        // Récupère le nombre de réclamations par fonction à partir du repository
